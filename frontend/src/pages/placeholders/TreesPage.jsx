  ...
  return (
    <div className="space-y-6">
      <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 text-center space-y-4">
        ...
        <h1 className="text-2xl font-bold text-white">My Plantations & Registration</h1>
        <p className="text-sm text-slate-400 max-w-lg mx-auto">
          Manage your registered trees, track verification audit progress, and view issued digital Tree IDs.
        </p>
        <div className="inline-block px-3.5 py-1.5 rounded-full bg-emerald-950/60 border border-emerald-500/30 text-emerald-400 text-xs font-semibold">
          Scheduled for Milestone 15 (Plantation Submission & Verification Flow)
        </div>
      </div>
    </div>
  );
